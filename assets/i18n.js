(function () {
  ...
  const translations = {
    tr: {
      ...
      lang: "tr",
      /* WEB-RC1-VISUAL-PREVIEW-I18N:tr:START */
      rc1_board_eyebrow: "Kontrollü karar yüzeyi",
      rc1_board_metric_1_label: "İncelenen maddeler",
      rc1_board_metric_1_value: "128",
      rc1_board_metric_2_label: "Açık inceleme",
      rc1_board_metric_2_value: "14",
      rc1_board_metric_3_label: "Kanıt izi",
      rc1_board_metric_3_value: "Madde bazlı",
      rc1_board_row_1_clause: "4.2",
      rc1_board_row_1_req: "Garanti süresi",
      rc1_board_row_1_status: "İncele",
      rc1_board_row_2_clause: "7.1",
      rc1_board_row_2_req: "Teslimat planı",
      rc1_board_row_2_status: "Uyumlu",
      rc1_board_row_3_clause: "9.4",
      rc1_board_row_3_req: "SLA kanıtı",
      rc1_board_row_3_status: "Kanıt gerekli",
      rc1_board_status: "İnsan incelemesi gerekli",
      rc1_board_table_clause: "Madde",
      rc1_board_table_requirement: "Gereksinim",
      rc1_board_table_status: "Durum",
      rc1_board_title: "Uyumluluk ve risk görünümü",
      rc1_demo_eyebrow: "Sentetik demo akışı",
      rc1_demo_intro: "Bu görsel akış public dosya yükleme veya production işlem kanalı değildir.",
      rc1_demo_panel_1_text: "Public web sitesi gerçek veya gizli ihale dosyalarını kabul etmez.",
      rc1_demo_panel_1_title: "Sentetik veya onaylı içerikle başlayın",
      rc1_demo_panel_2_text: "Doküman, inceleme için izlenebilir madde ve alanlara ayrılır.",
      rc1_demo_panel_2_title: "Maddeleri ve gereksinimleri yapılandırın",
      rc1_demo_panel_3_text: "Çıktılar karar desteğidir; nihai uyumluluk veya hukuki görüş değildir.",
      rc1_demo_panel_3_title: "Risk, gap ve kanıt sinyallerini üretin",
      rc1_demo_panel_4_text: "Öneriler düzenlenir, gerekçeler kontrol edilir ve açık noktalar sahiplenilir.",
      rc1_demo_panel_4_title: "Ekibiniz bulguları incelesin",
      rc1_demo_panel_5_text: "Onaylanan görünüm JSON, HTML, XLSX, ZIP ve manifest formatlarıyla sunulabilir.",
      rc1_demo_panel_5_title: "Kontrollü rapor paketini oluşturun",
      rc1_demo_step_1: "1. Doküman",
      rc1_demo_step_2: "2. Ayrıştırma",
      rc1_demo_step_3: "3. Analiz",
      rc1_demo_step_4: "4. İnsan incelemesi",
      rc1_demo_step_5: "5. Çıktı paketi",
      rc1_demo_title: "Beş adımda kontrollü inceleme",
      rc1_next_eyebrow: "Kontrollü sonraki adım",
      rc1_next_primary: "Demo talep et",
      rc1_next_secondary: "Örnek paketi gör",
      rc1_next_text: "Demo görüşmesinde kapsam, veri yönetimi, saklama ve insan inceleme sınırları birlikte netleştirilir.",
      rc1_next_title: "Gerçek dokümanlardan önce sentetik karar paketini inceleyin",
      rc1_output_eyebrow: "Kontrollü çıktı paketi",
      rc1_output_html_text: "Yönetici ve ekip incelemesi için erişilebilir, paylaşılabilir statik görünüm.",
      rc1_output_html_title: "Tarayıcıda okunabilir rapor",
      rc1_output_intro: "Format seçimi yalnızca tarayıcı içi görsel önizlemeyi değiştirir; ağ çağrısı veya dosya üretimi yapmaz.",
      rc1_output_json_text: "Kontrollü sonraki işlemler ve denetlenebilirlik için yapılandırılmış sonuç görünümü.",
      rc1_output_json_title: "Makine tarafından okunabilir yapı",
      rc1_output_manifest_text: "Dosya listesi ve paket seviyesi doğrulama bilgileri için manifest görünümü.",
      rc1_output_manifest_title: "Paket envanteri ve bütünlük izi",
      rc1_output_tab_html: "HTML",
      rc1_output_tab_json: "JSON",
      rc1_output_tab_manifest: "Manifest",
      rc1_output_tab_xlsx: "XLSX",
      rc1_output_tab_zip: "ZIP",
      rc1_output_title: "Aynı incelemenin farklı teslim formatları",
      rc1_output_xlsx_text: "Durum, risk, kanıt ve insan inceleme alanlarını tablo biçiminde taşır.",
      rc1_output_xlsx_title: "Madde bazlı uyumluluk matrisi",
      rc1_output_zip_text: "Onaylı formatları tek kontrollü arşiv altında birleştirir.",
      rc1_output_zip_title: "Taşınabilir çıktı paketi",
      rc1_process_1: "Dokümanı yapılandır",
      rc1_process_2: "Gereksinimleri çıkar",
      rc1_process_3: "Riskleri ve kanıtı eşleştir",
      rc1_process_4: "Ekibinizle inceleyin",
      rc1_process_5: "Kontrollü çıktıyı onaylayın",
      rc1_role_panel_1_text: "Teklif hazırlığı, temel engeller ve önerilen sonraki aksiyonlar öne çıkarılır.",
      rc1_role_panel_1_title: "Karar özeti ve ana riskler",
      rc1_role_panel_2_text: "Presales ekibi açıklama sorularını, ürün sinyallerini ve kanıt ihtiyaçlarını izler.",
      rc1_role_panel_2_title: "Gap, soru ve konumlandırma görünümü",
      rc1_role_panel_3_text: "Gereksinimler, teknik uyum ve doğrulama ihtiyacı kaynak maddelerle bağlı kalır.",
      rc1_role_panel_3_title: "Madde bazlı teknik inceleme",
      rc1_role_panel_4_text: "Açık maddeler, inceleme sahipleri ve insan onay durumu görünür tutulur.",
      rc1_role_panel_4_title: "İstisna ve onay takibi",
      rc1_role_tab_1: "Yönetici",
      rc1_role_tab_2: "Presales",
      rc1_role_tab_3: "Teknik",
      rc1_role_tab_4: "Uyumluluk",
      rc1_roles_eyebrow: "Rol bazlı karar desteği",
      rc1_roles_title: "Her ekip aynı kaynaktan farklı bir görünüm alır",
      rc1_story_eyebrow: "Ürün deneyimi",
      rc1_story_intro: "Her aşama kaynak maddeyi, yorumu, riski ve insan onayını aynı inceleme zincirinde tutar.",
      rc1_story_panel_1_text: "Başlıklar, maddeler ve gereksinimler kontrollü inceleme için ayrıştırılır.",
      rc1_story_panel_1_title: "Doküman yapısını görünür hale getirin",
      rc1_story_panel_2_text: "Teknik, ticari ve idari inceleme noktaları kaynak bağlamıyla birlikte gösterilir.",
      rc1_story_panel_2_title: "Risk ve belirsizlikleri erkenden işaretleyin",
      rc1_story_panel_3_text: "Eşleşmeler, gap notları ve kanıt ihtiyaçları aynı karar yüzeyinde karşılaştırılır.",
      rc1_story_panel_3_title: "Uyumluluk görünümünü ekipçe değerlendirin",
      rc1_story_panel_4_text: "Nihai yorum, düzeltme ve onay kullanıcılarınız ve ekibinizde kalır.",
      rc1_story_panel_4_title: "AI önerisini insan kararıyla ayırın",
      rc1_story_pause: "Otomatik akışı duraklat",
      rc1_story_resume: "Otomatik akışı sürdür",
      rc1_story_tab_1: "Yapılandır",
      rc1_story_tab_2: "İncele",
      rc1_story_tab_3: "Karşılaştır",
      rc1_story_tab_4: "Onayla",
      rc1_story_title: "Şartnameyi karar akışına dönüştürün",
      /* WEB-RC1-VISUAL-PREVIEW-I18N:tr:END */
      p4b_nav_login: "Giriş",
    ...
    en: {
      ...
      lang: "en",
      /* WEB-RC1-VISUAL-PREVIEW-I18N:en:START */
      rc1_board_eyebrow: "Controlled decision surface",
      rc1_board_metric_1_label: "Clauses reviewed",
      rc1_board_metric_1_value: "128",
      rc1_board_metric_2_label: "Open reviews",
      rc1_board_metric_2_value: "14",
      rc1_board_metric_3_label: "Evidence trail",
      rc1_board_metric_3_value: "Clause-linked",
      rc1_board_row_1_clause: "4.2",
      rc1_board_row_1_req: "Warranty period",
      rc1_board_row_1_status: "Review",
      rc1_board_row_2_clause: "7.1",
      rc1_board_row_2_req: "Delivery plan",
      rc1_board_row_2_status: "Aligned",
      rc1_board_row_3_clause: "9.4",
      rc1_board_row_3_req: "SLA evidence",
      rc1_board_row_3_status: "Evidence needed",
      rc1_board_status: "Human review required",
      rc1_board_table_clause: "Clause",
      rc1_board_table_requirement: "Requirement",
      rc1_board_table_status: "Status",
      rc1_board_title: "Compliance and risk view",
      rc1_demo_eyebrow: "Synthetic demo flow",
      rc1_demo_intro: "This visual flow is not a public upload or production processing channel.",
      rc1_demo_panel_1_text: "The public website does not accept real or confidential tender files.",
      rc1_demo_panel_1_title: "Start with synthetic or approved content",
      rc1_demo_panel_2_text: "The document is separated into traceable clauses and review areas.",
      rc1_demo_panel_2_title: "Structure clauses and requirements",
      rc1_demo_panel_3_text: "Outputs support decisions; they are not final compliance or legal opinions.",
      rc1_demo_panel_3_title: "Produce risk, gap and evidence signals",
      rc1_demo_panel_4_text: "Proposals are edited, rationales checked and open items assigned.",
      rc1_demo_panel_4_title: "Let your team review findings",
      rc1_demo_panel_5_text: "Approved views can be presented as JSON, HTML, XLSX, ZIP and manifest formats.",
      rc1_demo_panel_5_title: "Create the controlled report package",
      rc1_demo_step_1: "1. Document",
      rc1_demo_step_2: "2. Structure",
      rc1_demo_step_3: "3. Analysis",
      rc1_demo_step_4: "4. Human review",
      rc1_demo_step_5: "5. Output package",
      rc1_demo_title: "Controlled review in five steps",
      rc1_next_eyebrow: "Controlled next step",
      rc1_next_primary: "Request demo",
      rc1_next_secondary: "View sample package",
      rc1_next_text: "The demo discussion clarifies scope, data handling, retention and human-review boundaries.",
      rc1_next_title: "Review the synthetic decision package before real documents",
      rc1_output_eyebrow: "Controlled output package",
      rc1_output_html_text: "An accessible, shareable static view for executive and team review.",
      rc1_output_html_title: "Browser-readable report",
      rc1_output_intro: "The selector changes only the in-browser visual preview; it makes no network call or file generation request.",
      rc1_output_json_text: "A structured result view for controlled downstream processing and auditability.",
      rc1_output_json_title: "Machine-readable structure",
      rc1_output_manifest_text: "A manifest view for file inventory and package-level validation information.",
      rc1_output_manifest_title: "Package inventory and integrity trail",
      rc1_output_tab_html: "HTML",
      rc1_output_tab_json: "JSON",
      rc1_output_tab_manifest: "Manifest",
      rc1_output_tab_xlsx: "XLSX",
      rc1_output_tab_zip: "ZIP",
      rc1_output_title: "Different delivery formats for the same review",
      rc1_output_xlsx_text: "Carries status, risk, evidence and human review fields in a tabular format.",
      rc1_output_xlsx_title: "Clause-level compliance matrix",
      rc1_output_zip_text: "Combines approved formats under one controlled archive.",
      rc1_output_zip_title: "Portable output package",
      rc1_process_1: "Structure the document",
      rc1_process_2: "Extract requirements",
      rc1_process_3: "Link risk and evidence",
      rc1_process_4: "Review with your team",
      rc1_process_5: "Approve controlled outputs",
      rc1_role_panel_1_text: "Bid readiness, primary blockers and recommended next actions are highlighted.",
      rc1_role_panel_1_title: "Decision summary and key risks",
      rc1_role_panel_2_text: "Presales tracks clarification questions, product signals and evidence needs.",
      rc1_role_panel_2_title: "Gap, question and positioning view",
      rc1_role_panel_3_text: "Requirements, technical fit and validation needs remain linked to source clauses.",
      rc1_role_panel_3_title: "Clause-level technical review",
      rc1_role_panel_4_text: "Open clauses, review owners and human approval status remain visible.",
      rc1_role_panel_4_title: "Exception and approval tracking",
      rc1_role_tab_1: "Executive",
      rc1_role_tab_2: "Presales",
      rc1_role_tab_3: "Technical",
      rc1_role_tab_4: "Compliance",
      rc1_roles_eyebrow: "Role-based decision support",
      rc1_roles_title: "Each team gets a different view from the same source",
      rc1_story_eyebrow: "Product experience",
      rc1_story_intro: "Each stage keeps the source clause, interpretation, risk and human approval in one review chain.",
      rc1_story_panel_1_text: "Headings, clauses and requirements are separated for controlled review.",
      rc1_story_panel_1_title: "Make document structure visible",
      rc1_story_panel_2_text: "Technical, commercial and administrative review points remain linked to source context.",
      rc1_story_panel_2_title: "Flag risks and ambiguity early",
      rc1_story_panel_3_text: "Matches, gap notes and evidence needs are compared on the same decision surface.",
      rc1_story_panel_3_title: "Evaluate compliance as a team",
      rc1_story_panel_4_text: "Final interpretation, correction and approval remain with your users and team.",
      rc1_story_panel_4_title: "Separate AI proposals from human decisions",
      rc1_story_pause: "Pause automatic flow",
      rc1_story_resume: "Resume automatic flow",
      rc1_story_tab_1: "Structure",
      rc1_story_tab_2: "Review",
      rc1_story_tab_3: "Compare",
      rc1_story_tab_4: "Approve",
      rc1_story_title: "Turn specifications into a decision workflow",
      /* WEB-RC1-VISUAL-PREVIEW-I18N:en:END */
    ...
    zh: {
      language_label: "中文",
      lang: "zh-Hans",
      /* WEB-RC1-VISUAL-PREVIEW-I18N:zh:START */
      rc1_board_eyebrow: "受控决策界面",
      rc1_board_metric_1_label: "Clauses reviewed",
      rc1_board_metric_1_value: "128",
      rc1_board_metric_2_label: "Open reviews",
      rc1_board_metric_2_value: "14",
      ...
      rc1_board_row_3_req: "SLA evidence",
      rc1_board_row_3_status: "Evidence needed",
      rc1_board_status: "需要人工审核",
      rc1_board_table_clause: "Clause",
      rc1_board_table_requirement: "Requirement",
      rc1_board_table_status: "Status",
      rc1_board_title: "合规与风险视图",
      rc1_demo_eyebrow: "合成演示流程",
      rc1_demo_intro: "此视觉流程不是公开上传或生产处理通道。",
      rc1_demo_panel_1_text: "The public website does not accept real or confidential tender files.",
      rc1_demo_panel_1_title: "Start with synthetic or approved content",
      rc1_demo_panel_2_text: "The document is separated into traceable clauses and review areas.",
      rc1_demo_panel_2_title: "Structure clauses and requirements",
      ...
      rc1_demo_step_4: "4. Human review",
      rc1_demo_step_5: "5. Output package",
      rc1_demo_title: "五步受控审核",
      rc1_next_eyebrow: "受控下一步",
      rc1_next_primary: "申请演示",
      rc1_next_secondary: "查看示例包",
      rc1_next_text: "演示讨论将明确范围、数据处理、保留和人工审核边界。",
      rc1_next_title: "在使用真实文档前先审核合成决策包",
      rc1_output_eyebrow: "受控输出包",
      rc1_output_html_text: "An accessible, shareable static view for executive and team review.",
      rc1_output_html_title: "Browser-readable report",
      rc1_output_intro: "选择器仅改变浏览器内预览，不发起网络调用或文件生成。",
      rc1_output_json_text: "A structured result view for controlled downstream processing and auditability.",
      rc1_output_json_title: "Machine-readable structure",
      rc1_output_manifest_text: "A manifest view for file inventory and package-level validation information.",
      rc1_output_manifest_title: "Package inventory and integrity trail",
      ...
      rc1_process_1: "结构化文档",
      rc1_process_2: "提取要求",
      rc1_process_3: "关联风险与证据",
      rc1_process_4: "由团队审核",
      rc1_process_5: "批准受控输出",
      rc1_role_panel_1_text: "Bid readiness, primary blockers and recommended next actions are highlighted.",
      rc1_role_panel_1_title: "Decision summary and key risks",
      rc1_role_panel_2_text: "Presales tracks clarification questions, product signals and evidence needs.",
      rc1_role_panel_2_title: "Gap, question and positioning view",
      ...
      rc1_role_tab_3: "技术",
      rc1_role_tab_4: "合规",
      rc1_roles_eyebrow: "基于角色的决策支持",
      rc1_roles_title: "不同团队从同一来源获得不同视图",
      rc1_story_eyebrow: "产品体验",
      rc1_story_intro: "每个阶段都在同一审核链中保留来源条款、解释、风险和人工批准。",
      rc1_story_panel_1_text: "Headings, clauses and requirements are separated for controlled review.",
      rc1_story_panel_1_title: "Make document structure visible",
      rc1_story_panel_2_text: "Technical, commercial and administrative review points remain linked to source context.",
      rc1_story_panel_2_title: "Flag risks and ambiguity early",
      ...
      rc1_story_panel_4_text: "Final interpretation, correction and approval remain with your users and team.",
      rc1_story_panel_4_title: "Separate AI proposals from human decisions",
      rc1_story_pause: "暂停自动流程",
      rc1_story_resume: "继续自动流程",
      rc1_story_tab_1: "结构化",
      rc1_story_tab_2: "审核",
      rc1_story_tab_3: "比较",
      rc1_story_tab_4: "批准",
      rc1_story_title: "将技术规格转化为决策流程",
      /* WEB-RC1-VISUAL-PREVIEW-I18N:zh:END */
      p4b_nav_login: "登录",
      p4b_nav_signup: "注册",
    ...
    ru: {
      ...
      lang: "ru",
      /* WEB-RC1-VISUAL-PREVIEW-I18N:ru:START */
      rc1_board_eyebrow: "Контролируемая поверхность решений",
      rc1_board_metric_1_label: "Clauses reviewed",
      rc1_board_metric_1_value: "128",
      rc1_board_metric_2_label: "Open reviews",
      rc1_board_metric_2_value: "14",
      ...
      rc1_board_row_3_req: "SLA evidence",
      rc1_board_row_3_status: "Evidence needed",
      rc1_board_status: "Требуется проверка человеком",
      rc1_board_table_clause: "Clause",
      rc1_board_table_requirement: "Requirement",
      rc1_board_table_status: "Status",
      rc1_board_title: "Обзор соответствия и рисков",
      rc1_demo_eyebrow: "Синтетический демо-процесс",
      rc1_demo_intro: "Этот визуальный процесс не является публичной загрузкой или production-каналом обработки.",
      rc1_demo_panel_1_text: "The public website does not accept real or confidential tender files.",
      rc1_demo_panel_1_title: "Start with synthetic or approved content",
      rc1_demo_panel_2_text: "The document is separated into traceable clauses and review areas.",
      rc1_demo_panel_2_title: "Structure clauses and requirements",
      ...
      rc1_demo_step_4: "4. Human review",
      rc1_demo_step_5: "5. Output package",
      rc1_demo_title: "Контролируемая проверка за пять шагов",
      rc1_next_eyebrow: "Контролируемый следующий шаг",
      rc1_next_primary: "Запросить демо",
      rc1_next_secondary: "Посмотреть пример пакета",
      rc1_next_text: "На демо обсуждаются границы объема, обработки данных, хранения и человеческой проверки.",
      rc1_next_title: "Проверьте синтетический пакет решений до использования реальных документов",
      rc1_output_eyebrow: "Контролируемый пакет результатов",
      rc1_output_html_text: "An accessible, shareable static view for executive and team review.",
      rc1_output_html_title: "Browser-readable report",
      rc1_output_intro: "Переключатель меняет только визуальный предпросмотр в браузере и не выполняет сетевых вызовов или генерации файлов.",
      rc1_output_json_text: "A structured result view for controlled downstream processing and auditability.",
      rc1_output_json_title: "Machine-readable structure",
      rc1_output_manifest_text: "A manifest view for file inventory and package-level validation information.",
      rc1_output_manifest_title: "Package inventory and integrity trail",
      ...
      rc1_output_tab_xlsx: "XLSX",
      rc1_output_tab_zip: "ZIP",
      rc1_output_title: "Разные форматы доставки одной проверки",
      rc1_output_xlsx_text: "Carries status, risk, evidence and human review fields in a tabular format.",
      rc1_output_xlsx_title: "Clause-level compliance matrix",
      rc1_output_zip_text: "Combines approved formats under one controlled archive.",
      rc1_output_zip_title: "Portable output package",
      rc1_process_1: "Структурировать документ",
      rc1_process_2: "Извлечь требования",
      rc1_process_3: "Связать риски и доказательства",
      rc1_process_4: "Проверить командой",
      rc1_process_5: "Утвердить контролируемые результаты",
      rc1_role_panel_1_text: "Bid readiness, primary blockers and recommended next actions are highlighted.",
      rc1_role_panel_1_title: "Decision summary and key risks",
      rc1_role_panel_2_text: "Presales tracks clarification questions, product signals and evidence needs.",
      rc1_role_panel_2_title: "Gap, question and positioning view",
      ...
      rc1_role_panel_4_text: "Open clauses, review owners and human approval status remain visible.",
      rc1_role_panel_4_title: "Exception and approval tracking",
      rc1_role_tab_1: "Руководитель",
      rc1_role_tab_2: "Presales",
      rc1_role_tab_3: "Технический",
      rc1_role_tab_4: "Соответствие",
      rc1_roles_eyebrow: "Поддержка решений по ролям",
      rc1_roles_title: "Каждая команда получает свой вид из одного источника",
      rc1_story_eyebrow: "Продуктовый опыт",
      rc1_story_intro: "Каждый этап сохраняет исходный пункт, интерпретацию, риск и человеческое одобрение в одной цепочке проверки.",
      rc1_story_panel_1_text: "Headings, clauses and requirements are separated for controlled review.",
      rc1_story_panel_1_title: "Make document structure visible",
      rc1_story_panel_2_text: "Technical, commercial and administrative review points remain linked to source context.",
      rc1_story_panel_2_title: "Flag risks and ambiguity early",
      ...
      rc1_story_panel_4_text: "Final interpretation, correction and approval remain with your users and team.",
      rc1_story_panel_4_title: "Separate AI proposals from human decisions",
      rc1_story_pause: "Приостановить автоматический поток",
      rc1_story_resume: "Продолжить автоматический поток",
      rc1_story_tab_1: "Структура",
      rc1_story_tab_2: "Проверка",
      rc1_story_tab_3: "Сравнение",
      rc1_story_tab_4: "Одобрение",
      rc1_story_title: "Превратите спецификацию в процесс принятия решений",
      /* WEB-RC1-VISUAL-PREVIEW-I18N:ru:END */
      p4b_nav_login: "Вход",
    ...
    ar: {
      ...
      lang: "ar",
      /* WEB-RC1-VISUAL-PREVIEW-I18N:ar:START */
      rc1_board_eyebrow: "واجهة قرار مضبوطة",
      rc1_board_metric_1_label: "Clauses reviewed",
      rc1_board_metric_1_value: "128",
      rc1_board_metric_2_label: "Open reviews",
      rc1_board_metric_2_value: "14",
      ...
      rc1_board_row_3_req: "SLA evidence",
      rc1_board_row_3_status: "Evidence needed",
      rc1_board_status: "المراجعة البشرية مطلوبة",
      rc1_board_table_clause: "Clause",
      rc1_board_table_requirement: "Requirement",
      rc1_board_table_status: "Status",
      rc1_board_title: "عرض التوافق والمخاطر",
      rc1_demo_eyebrow: "تدفق عرض تركيبي",
      rc1_demo_intro: "هذا التدفق المرئي ليس قناة رفع عامة أو معالجة production.",
      rc1_demo_panel_1_text: "The public website does not accept real or confidential tender files.",
      rc1_demo_panel_1_title: "Start with synthetic or approved content",
      rc1_demo_panel_2_text: "The document is separated into traceable clauses and review areas.",
      rc1_demo_panel_2_title: "Structure clauses and requirements",
      ...
      rc1_demo_step_4: "4. Human review",
      rc1_demo_step_5: "5. Output package",
      rc1_demo_title: "مراجعة مضبوطة في خمس خطوات",
      rc1_next_eyebrow: "الخطوة التالية المضبوطة",
      rc1_next_primary: "طلب عرض",
      rc1_next_secondary: "عرض الحزمة النموذجية",
      rc1_next_text: "توضح مناقشة العرض النطاق ومعالجة البيانات والاحتفاظ وحدود المراجعة البشرية.",
      rc1_next_title: "راجع حزمة القرار التركيبية قبل المستندات الحقيقية",
      rc1_output_eyebrow: "حزمة مخرجات مضبوطة",
      rc1_output_html_text: "An accessible, shareable static view for executive and team review.",
      rc1_output_html_title: "Browser-readable report",
      rc1_output_intro: "يغير المحدد المعاينة المرئية داخل المتصفح فقط ولا يجري اتصالاً شبكياً أو طلب إنشاء ملف.",
      rc1_output_json_text: "A structured result view for controlled downstream processing and auditability.",
      rc1_output_json_title: "Machine-readable structure",
      rc1_output_manifest_text: "A manifest view for file inventory and package-level validation information.",
      rc1_output_manifest_title: "Package inventory and integrity trail",
      ...
      rc1_output_tab_xlsx: "XLSX",
      rc1_output_tab_zip: "ZIP",
      rc1_output_title: "تنسيقات تسليم مختلفة للمراجعة نفسها",
      rc1_output_xlsx_text: "Carries status, risk, evidence and human review fields in a tabular format.",
      rc1_output_xlsx_title: "Clause-level compliance matrix",
      rc1_output_zip_text: "Combines approved formats under one controlled archive.",
      rc1_output_zip_title: "Portable output package",
      rc1_process_1: "هيكلة المستند",
      rc1_process_2: "استخراج المتطلبات",
      rc1_process_3: "ربط المخاطر بالأدلة",
      rc1_process_4: "المراجعة مع الفريق",
      rc1_process_5: "اعتماد المخرجات المضبوطة",
      rc1_role_panel_1_text: "Bid readiness, primary blockers and recommended next actions are highlighted.",
      rc1_role_panel_1_title: "Decision summary and key risks",
      rc1_role_panel_2_text: "Presales tracks clarification questions, product signals and evidence needs.",
      rc1_role_panel_2_title: "Gap, question and positioning view",
      ...
      rc1_role_panel_4_text: "Open clauses, review owners and human approval status remain visible.",
      rc1_role_panel_4_title: "Exception and approval tracking",
      rc1_role_tab_1: "الإدارة",
      rc1_role_tab_2: "ما قبل البيع",
      rc1_role_tab_3: "الفني",
      rc1_role_tab_4: "التوافق",
      rc1_roles_eyebrow: "دعم قرار حسب الدور",
      rc1_roles_title: "يحصل كل فريق على عرض مختلف من المصدر نفسه",
      rc1_story_eyebrow: "تجربة المنتج",
      rc1_story_intro: "تحافظ كل مرحلة على البند المصدر والتفسير والمخاطر والموافقة البشرية ضمن سلسلة مراجعة واحدة.",
      rc1_story_panel_1_text: "Headings, clauses and requirements are separated for controlled review.",
      rc1_story_panel_1_title: "Make document structure visible",
      rc1_story_panel_2_text: "Technical, commercial and administrative review points remain linked to source context.",
      rc1_story_panel_2_title: "Flag risks and ambiguity early",
      ...
      rc1_story_panel_4_text: "Final interpretation, correction and approval remain with your users and team.",
      rc1_story_panel_4_title: "Separate AI proposals from human decisions",
      rc1_story_pause: "إيقاف التدفق التلقائي",
      rc1_story_resume: "استئناف التدفق التلقائي",
      rc1_story_tab_1: "الهيكلة",
      rc1_story_tab_2: "المراجعة",
      rc1_story_tab_3: "المقارنة",
      rc1_story_tab_4: "الاعتماد",
      rc1_story_title: "حوّل المواصفات إلى مسار قرار",
      /* WEB-RC1-VISUAL-PREVIEW-I18N:ar:END */
